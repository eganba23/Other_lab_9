...
df_percent <- count(percent_accurate, compas_accurate)
...
total <- df_percent %>% summarize(sum = sum(n))

accurate/total*100

```

It seems to be accurate to a degree. There is a high amount of people that are ambiguous (i.e. not having a high or low degree of crime).
